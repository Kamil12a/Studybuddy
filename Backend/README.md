...
- You need .NET 5 and SQL server installed. (Optionally: Microsoft SQL Server Managment Studio to manage your local database)

You need the command-line interface (CLI) tools for Entity Framework Core if you want to setup via terminal.
- dotnet tool install --global dotnet-ef
...
- Clone this repo to your local machine using `https://github.com/Kamil12a/Studdybuddy.git`
...
> go into \StudyBuddy.API and run

```shell
$ dotnet restore
```

> now add "Study-Buddy!" database to your SQL server environment

```shell
$ dotnet ef database update
```

> now you can run your API by
...
---
IF STUDY BUDDY WAS OPEN SOURCE ONLY!!!
## Contributing
